...
var WETH = {
  ...
  "128": new _sdk.Token(128, '0x5545153CCFcA01fbd7Dd11C0b23ba694D9509A6F', 18, 'WHT', "Wrapped HT")
};
          ...
          while (1) {
            switch (_context33.prev = _context33.next) {
              ...
              case 15:
                ...
                erc20Token = pair.token0.address === WETH[pair.token0.chainId] ? pair.token1 : pair.token0;
                deadline = Math.floor(Date.now() / 1000) + 60 * 120; // 120 minutes from the current Unix time
                // contract:
                ...
                return _context33.abrupt("return", this.triggerContract({
                  ...
                  abiKey: 'uniswapExchange',
                  abiString: this.ABIs['uniswapExchange'].abi,
                  contractParams: [erc20Token.address, parsedAmounts[erc20Token.address].raw.toString(), amountsMin[erc20Token.address].toString(), amountsMin[WETH[pair.token0.chainId].address].toString(), to, deadline],
                  sendParams: {
          ...
          while (1) {
            switch (_context35.prev = _context35.next) {
              ...
              case 13:
                ...
                console.log([erc20Token.address, parsedAmounts[pair.liquidityToken.address].raw.toString(), amountsMin[erc20Token.address].toString(), amountsMin[WETH[pair.token0.chainId].address].toString(), to, deadline]); // https://uniswap.org/docs/v2/smart-contracts/router02/#removeliquidity
                ...
                return _context35.abrupt("return", this.triggerContract({
                  ...
                  abiKey: 'uniswapExchange',
                  abiString: this.ABIs['uniswapExchange'].abi,
                  contractParams: [erc20Token.address, parsedAmounts[pair.liquidityToken.address].raw.toString(), amountsMin[erc20Token.address].toString(), amountsMin[WETH[pair.token0.chainId].address].toString(), to, deadline],
                  sendParams: {
                    value: 0
                  }
                }, callback));
