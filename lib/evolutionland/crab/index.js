...
var CrabEvolutionLand = /*#__PURE__*/function () {
  /**
   * constructor function.
   * @param {object} web3js - web3js instance
   * @param {string} network
   */
  function CrabEvolutionLand(web3js, network) {
    var option = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    _classCallCheck(this, CrabEvolutionLand);
  ...
  _createClass(CrabEvolutionLand, [{
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                ...
                _context9.next = 6;
                return _sdk.Fetcher.fetchPairData(_sdk.WETH[RING.chainId], RING, this.etherjsProvider);
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                RING = new _sdk.Token(parseInt(this.env.CONTRACT.NETWORK), this.env.CONTRACT.TOKEN_RING, 18, "RING", "Darwinia Network Native Token");
                _context10.next = 6;
                return _sdk.Fetcher.fetchPairData(RING, _sdk.WETH[RING.chainId], this.etherjsProvider);
    ...
    */
          ...
          while (1) {
            switch (_context29.prev = _context29.next) {
              ...
              case 4:
                ...
                _context29.next = 8;
                return _sdk.Fetcher.fetchPairData(currencyA, currencyB, this.etherjsProvider);
    ...
    value: function () {
      var _addUniswapETHLiquidity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee33(value, params) {
        var callback,
            _args33 = arguments;
        return regeneratorRuntime.wrap(function _callee33$(_context33) {
          while (1) {
            switch (_context33.prev = _context33.next) {
              case 0:
                callback = _args33.length > 2 && _args33[2] !== undefined ? _args33[2] : {};
    ...
    key: "_sign",
    value: function () {
      var _sign2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee35(_ref12, from) {
    ...
    key: "login",
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee36(address) {
        var _this2 = this;
  ...
  return CrabEvolutionLand;
}();

Object.assign(CrabEvolutionLand.prototype, _erc["default"]);
Object.assign(CrabEvolutionLand.prototype, _apostle["default"]);
Object.assign(CrabEvolutionLand.prototype, _furnace["default"]);
Object.assign(CrabEvolutionLand.prototype, _land["default"]);
var _default = CrabEvolutionLand;
