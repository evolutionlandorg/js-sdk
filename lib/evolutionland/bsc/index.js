...
var _abiBancor = _interopRequireDefault(require("./env/abi/ethereum/abi-bancor"));

var _abiAuction = _interopRequireDefault(require("./env/abi/ethereum/abi-auction"));

var _abiRing = _interopRequireDefault(require("./env/abi/ethereum/abi-ring"));

var _abiWithdraw = _interopRequireDefault(require("./env/abi/ethereum/abi-withdraw"));

var _abiBank = _interopRequireDefault(require("./env/abi/ethereum/abi-bank"));

var _abiKton = _interopRequireDefault(require("./env/abi/ethereum/abi-kton"));

var _abiLand = _interopRequireDefault(require("./env/abi/ethereum/abi-land"));

var _abiLottery = _interopRequireDefault(require("./env/abi/ethereum/abi-lottery"));

var _abiRolesUpdater = _interopRequireDefault(require("./env/abi/ethereum/abi-rolesUpdater"));

var _abiLandResource = _interopRequireDefault(require("./env/abi/ethereum/abi-landResource"));

var _abiApostleAuction = _interopRequireDefault(require("./env/abi/ethereum/abi-apostleAuction"));

var _abiTakeBack = _interopRequireDefault(require("./env/abi/ethereum/abi-takeBack"));

var _abiApostleSiring = _interopRequireDefault(require("./env/abi/ethereum/abi-apostleSiring"));

var _abiApostleBase = _interopRequireDefault(require("./env/abi/ethereum/abi-apostleBase"));

var _abiTokenUse = _interopRequireDefault(require("./env/abi/ethereum/abi-tokenUse"));

var _abiPetbase = _interopRequireDefault(require("./env/abi/ethereum/abi-petbase"));

var _abiUniswapExchangeV = _interopRequireDefault(require("./env/abi/ethereum/abi-uniswapExchangeV2"));

var _abiSwapBridge = _interopRequireDefault(require("./env/abi/ethereum/abi-swapBridge"));

var _abiLuckyBag = _interopRequireDefault(require("./env/abi/ethereum/abi-luckyBag"));

var _abiItemTreasure = _interopRequireDefault(require("./env/abi/ethereum/abi-itemTreasure"));

var _abiItemTakeBack = _interopRequireDefault(require("./env/abi/ethereum/abi-itemTakeBack"));

var _abiFurnaceItemBase = _interopRequireDefault(require("./env/abi/ethereum/abi-furnaceItemBase"));
...
var WETH = {
  // TODO
  "97": new _sdk.Token(97, '0xae13d989dac2f0debff460ac112a837c89baa7cd', 18, 'WBNB', "Wrapped BNB")
};
...
var BscEvolutionLand = /*#__PURE__*/function () {
  /**
   * constructor function.
   * @param {object} web3js - web3js instance
   * @param {string} network
   */
  function BscEvolutionLand(web3js, network) {
    var option = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    _classCallCheck(this, BscEvolutionLand);
  ...
  _createClass(BscEvolutionLand, [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 77:
                _contractAddress = _context2.sent;
    ...
    value: function () {
      var _getContractAddress = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(tokenKey) {
        var token;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                token = this.ABIs[tokenKey] && this.ABIs[tokenKey].address || tokenKey; // if(Array.isArray(tokenKey) && tokenKey.length === 2) {
      ...
      function getContractAddress(_x3) {
    ...
    value: function () {
      var _erc721IsApprovedOrOwner = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(spender, contractAddress, tokenId) {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                approvedAddress = _context5.sent;
                _context5.next = 8;
                return this.erc721IsApprovedForAll(owner, spender, contractAddress);

              case 8:
                isApprovedForAll = _context5.sent;
                return _context5.abrupt("return", owner.toLowerCase() === spender.toLowerCase() || approvedAddress.toLowerCase() === spender.toLowerCase() || isApprovedForAll);
      ...
      function erc721IsApprovedOrOwner(_x4, _x5, _x6) {
    ...
    key: "erc721Approve",
    value: function () {
      var _erc721Approve = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(to, tokenId, contractAddress) {
        var callback,
            _args6 = arguments;
      ...
      function erc721Approve(_x7, _x8, _x9) {
    ...
    value: function () {
      var _erc721SetApprovalForAll = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(to, approved, contractAddress) {
        var callback,
            _args7 = arguments;
      ...
      function erc721SetApprovalForAll(_x10, _x11, _x12) {
    ...
    value: function () {
      var _fetchAtlantisSwapFee = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(value) {
        var callback,
            _args8 = arguments;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return _context8.abrupt("return", this.callContract({
      ...
      function fetchAtlantisSwapFee(_x13) {
    ...
    value: function () {
      var _AtlantisSwapBridge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(value, targetAddress) {
        var symbol,
            callback,
            fee,
            hexTargetAddress,
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                symbol = _args9.length > 2 && _args9[2] !== undefined ? _args9[2] : 'ring';
                callback = _args9.length > 3 && _args9[3] !== undefined ? _args9[3] : {};
      ...
      function AtlantisSwapBridge(_x14, _x15) {
    ...
    key: "buyRingUniswap",
    value: function () {
      var _buyRingUniswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(value) {
        var callback,
            RING,
            pair,
            route,
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                ...
                _context10.next = 6;
                return _uniswapFetcher.Fetcher.fetchPairData(WETH[RING.chainId], RING, this.etherjsProvider);

              case 6:
                pair = _context10.sent;
                route = new _sdk.Route([pair], WETH[RING.chainId]);
                amountIn = value;
                ...
                path = [WETH[RING.chainId].address, RING.address];
                _context10.next = 15;
                return this.getCurrentAccount();
              ...
              case 15:
                ...
                return _context10.abrupt("return", this.triggerContract({
                  ...
                  abiString: _abiUniswapExchangeV["default"],
    ...
    key: "sellRingUniswap",
    value: function () {
      var _sellRingUniswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(value) {
        var callback,
            RING,
            pair,
            route,
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                callback = _args11.length > 1 && _args11[1] !== undefined ? _args11[1] : {};
                _context11.next = 3;
                return this.setEtherjsProvider();
              ...
              case 3:
                RING = new _sdk.Token(parseInt(this.env.CONTRACT.NETWORK), this.env.CONTRACT.TOKEN_RING, 18, "RING", "Darwinia Network Native Token");
                _context11.next = 6;
                return _uniswapFetcher.Fetcher.fetchPairData(RING, WETH[RING.chainId], this.etherjsProvider);

              case 6:
                pair = _context11.sent;
                ...
                path = [RING.address, WETH[RING.chainId].address];
                _context11.next = 15;
                return this.getCurrentAccount();
    ...
    key: "tokenTransfer",
    value: function () {
      var _tokenTransfer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(value, to, symbol) {
        var callback,
            abiString,
            _args12 = arguments;
      ...
      function tokenTransfer(_x18, _x19, _x20) {
    ...
    value: function () {
      var _approveRingToUniswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
        var callback,
            value,
            _args13 = arguments;
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                callback = _args13.length > 0 && _args13[0] !== undefined ? _args13[0] : {};
                value = _args13.length > 1 && _args13[1] !== undefined ? _args13[1] : "20000000000000000000000000";
    ...
    value: function () {
      var _approveLiquidityTokenToUniswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(tokenAType, tokenBType) {
        var value,
            callback,
            pair,
            _args14 = arguments;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 6:
                ...
                return _context14.abrupt("return", this.approveTokenToUniswap(pair.liquidityToken.address, value, callback));
      ...
      function approveLiquidityTokenToUniswap(_x21, _x22) {
    ...
    key: "approveToken",
    value: function () {
      var _approveToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(tokenContractOrType, spender) {
        var value,
            callback,
            _args15 = arguments;
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                value = _args15.length > 2 && _args15[2] !== undefined ? _args15[2] : "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff";
                callback = _args15.length > 3 && _args15[3] !== undefined ? _args15[3] : {};
      ...
      function approveToken(_x23, _x24) {
    ...
    value: function () {
      var _approveUniswapLiquidityToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(tokenAType, tokenBType, spender) {
        var value,
            callback,
            pair,
            _args16 = arguments;
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                value = _args16.length > 3 && _args16[3] !== undefined ? _args16[3] : "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff";
                callback = _args16.length > 4 && _args16[4] !== undefined ? _args16[4] : {};
              ...
              case 6:
                pair = _context16.sent;
                return _context16.abrupt("return", this.triggerContract({
                  methodName: 'approve',
      ...
      function approveUniswapLiquidityToken(_x25, _x26, _x27) {
    ...
    value: function () {
      var _checkUniswapAllowance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(amount) {
        ...
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                tokenAddressOrType = _args17.length > 1 && _args17[1] !== undefined ? _args17[1] : 'ring';
                account = _args17.length > 2 ? _args17[2] : undefined;
              ...
              case 10:
                ...
                erc20Contract = new this._web3js.eth.Contract(_abiRing["default"], token);
                _context17.next = 14;
      ...
      function checkUniswapAllowance(_x28) {
    ...
    value: function () {
      var _checkTokenAllowance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(amount, tokenAddressOrType, account, spender) {
        ...
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              ...
              case 14:
                allowanceAmount = _context18.sent;
                return _context18.abrupt("return", !_index["default"].toBN(allowanceAmount).lt(_index["default"].toBN(amount || '1000000000000000000000000')));
      ...
      function checkTokenAllowance(_x29, _x30, _x31, _x32) {
    ...
    value: function () {
      var _getUniswapEthBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
        var RING, pair;
          ...
          while (1) {
            switch (_context19.prev = _context19.next) {
              ...
              case 5:
                ...
                return _context19.abrupt("return", pair.tokenAmounts[0].token.equals(WETH[RING.chainId]) ? pair.tokenAmounts[0].raw.toString(10) : pair.tokenAmounts[1].raw.toString(10));
    ...
    */
    ...
    value: function () {
      var _getUniswapTokenBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20() {
        var RING, pair;
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              ...
              case 5:
                ...
                return _context20.abrupt("return", pair.tokenAmounts[0].token.equals(RING) ? pair.tokenAmounts[0].raw.toString(10) : pair.tokenAmounts[1].raw.toString(10));
    ...
    value: function () {
      var _getEthToTokenOutputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21() {
        var tokens_bought,
            RING,
            pair,
            route,
          ...
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 6:
                ...
                return _context21.abrupt("return", [new _bignumber["default"](amountInMax.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountInMax.toString(10)]);
    ...
    */
    ...
    value: function () {
      var _getTokenToEthInputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22() {
        var tokens_bought,
            RING,
            pair,
            route,
        ...
        return regeneratorRuntime.wrap(function _callee22$(_context22) {
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
                tokens_bought = _args22.length > 0 && _args22[0] !== undefined ? _args22[0] : '1000000000000000000';
                _context22.next = 3;
                return this.setEtherjsProvider();
              ...
              case 6:
                ...
                return _context22.abrupt("return", [new _bignumber["default"](amountOutMin.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountOutMin.toString(10)]);
    ...
    key: "buyRing",
    value: function buyRing(value) {
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return this.triggerContract({
        methodName: 'buyRING',
        abiKey: 'bancor',
        abiString: _abiBancor["default"],
        contractParams: [1],
        sendParams: {
          value: value
        }
    ...
    key: "setLandPrice",
    value: function () {
      var _setLandPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23(tokenId, start, end, duration) {
        var callback,
            from,
            _from,
            _start,
      ...
      function setLandPrice(_x33, _x34, _x35, _x36) {
    ...
    value: function () {
      var _transferFromLand = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24(to, tokenId) {
        var callback,
            from,
            _args24 = arguments;
        return regeneratorRuntime.wrap(function _callee24$(_context24) {
          while (1) {
            switch (_context24.prev = _context24.next) {
              case 0:
                callback = _args24.length > 2 && _args24[2] !== undefined ? _args24[2] : {};
      ...
      function transferFromLand(_x37, _x38) {
    ...
    key: "apostleSell",
    value: function () {
      var _apostleSell = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(tokenId, start, end, duration) {
        var callback,
            from,
            _from,
            _start,
      ...
      function apostleSell(_x39, _x40, _x41, _x42) {
    ...
    value: function () {
      var _apostleBreedAuction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(tokenId, start, end, duration) {
        var callback,
            from,
            _from,
            _start,
        ...
        return regeneratorRuntime.wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                callback = _args26.length > 4 && _args26[4] !== undefined ? _args26[4] : {};
                _context26.next = 3;
                return this.getCurrentAccount();
      ...
      function apostleBreedAuction(_x43, _x44, _x45, _x46) {
    ...
    key: "apostleTransfer",
    value: function () {
      var _apostleTransfer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee27(toAddress, tokenId) {
        var callback,
            from,
            _args27 = arguments;
        return regeneratorRuntime.wrap(function _callee27$(_context27) {
          while (1) {
            switch (_context27.prev = _context27.next) {
              case 0:
                callback = _args27.length > 2 && _args27[2] !== undefined ? _args27[2] : {};
                _context27.next = 3;
                return this.getCurrentAccount();

              case 3:
                from = _context27.sent;
      ...
      function apostleTransfer(_x47, _x48) {
    ...
    key: "buyLuckyBox",
    value: function () {
      var _buyLuckyBox = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee28(buyer, goldBoxAmount, silverBoxAmount, callback) {
      ...
      function buyLuckyBox(_x49, _x50, _x51, _x52) {
    ...
    value: function getLuckyBoxInfo() {
      var _contract = new this._web3js.eth.Contract(_abiLuckyBag["default"], this.ABIs['luckybag'].address);
    ...
    value: function getFurnaceTreasurePrice() {
      var _contract = new this._web3js.eth.Contract(_abiItemTreasure["default"], this.ABIs['itemTreasure'].address);
    ...
    value: function getFurnaceTakeBackNonce(address) {
      var _contract = new this._web3js.eth.Contract(_abiItemTakeBack["default"], this.ABIs['itemTakeBack'].address);
    ...
    value: function () {
      var _buyFurnaceTreasure = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee29() {
        var goldBoxAmount,
            silverBoxAmount,
            callback,
            treasurePrice,
        ...
        return regeneratorRuntime.wrap(function _callee29$(_context29) {
          while (1) {
            switch (_context29.prev = _context29.next) {
              case 0:
                goldBoxAmount = _args29.length > 0 && _args29[0] !== undefined ? _args29[0] : 0;
                silverBoxAmount = _args29.length > 1 && _args29[1] !== undefined ? _args29[1] : 0;
                callback = _args29.length > 2 ? _args29[2] : undefined;
                _context29.next = 5;
                return this.getFurnaceTreasurePrice();

              case 5:
                treasurePrice = _context29.sent;
                ...
                return _context29.abrupt("return", this.triggerContract({
                  methodName: 'transfer',
                  abiKey: 'ring',
                  abiString: _abiRing["default"],
    ...
    */
    ...
    value: function openFurnaceTreasure(_ref7) {
      ...
      return this.triggerContract({
        ...
        abiString: _abiItemTakeBack["default"],
    ...
    value: function getRingBalance(address) {
      var _contract = new this._web3js.eth.Contract(_abiRing["default"], this.ABIs['ring'].address);
    ...
    value: function getKtonBalance(address) {
      var _contract = new this._web3js.eth.Contract(_abiKton["default"], this.ABIs['kton'].address);
    ...
    value: function getTokenBalance(account, contractAddress) {
      var _contract = new this._web3js.eth.Contract(_abiRing["default"], contractAddress);
    ...
    value: function () {
      var _transferFromObjectOwnership = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee30(to, tokenId) {
        var callback,
            from,
            _args30 = arguments;
        return regeneratorRuntime.wrap(function _callee30$(_context30) {
          while (1) {
            switch (_context30.prev = _context30.next) {
              case 0:
                callback = _args30.length > 2 && _args30[2] !== undefined ? _args30[2] : {};
              ...
              case 5:
                from = _context30.sent;
                return _context30.abrupt("return", this.triggerContract({
                  methodName: 'transferFrom',
                  abiKey: 'land',
                  abiString: _abiLand["default"],
                  contractParams: [from, to, '0x' + tokenId]
      ...
      function transferFromObjectOwnership(_x53, _x54) {
    ...
    value: function () {
      var _getDerivedPairInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee31(tokenA, tokenB) {
          ...
          while (1) {
            switch (_context31.prev = _context31.next) {
              ...
              case 8:
                ...
                return _context31.abrupt("return", pair);
      ...
      function getDerivedPairInfo(_x55, _x56) {
    ...
    value: function () {
      var _getDerivedMintInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee32(_ref8, _ref9) {
        var _parsedAmounts;
        ...
        return regeneratorRuntime.wrap(function _callee32$(_context32) {
          while (1) {
            switch (_context32.prev = _context32.next) {
              ...
              case 4:
                pair = _context32.sent;
                _context32.t0 = _sdk.TokenAmount;
                _context32.t1 = pair.liquidityToken;
                _context32.next = 9;
                return this.getTokenTotalSupply(pair.liquidityToken.address);

              case 9:
                _context32.t2 = _context32.sent;
                totalSupply = new _context32.t0(_context32.t1, _context32.t2);
      ...
      function getDerivedMintInfo(_x57, _x58) {
    ...
    value: function () {
      var _getDerivedBurnInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee33(tokenAType, tokenBType, liquidityValue, to) {
        var _parsedAmounts2;
        ...
        return regeneratorRuntime.wrap(function _callee33$(_context33) {
          while (1) {
            switch (_context33.prev = _context33.next) {
              ...
              case 9:
                lpBalanceStr = _context33.sent;
                userLiquidity = new _sdk.TokenAmount(pair.liquidityToken, _sdk.JSBI.BigInt(lpBalanceStr));
                _context33.t0 = _sdk.TokenAmount;
                _context33.t1 = pair.liquidityToken;
                _context33.next = 15;
                return this.getTokenTotalSupply(pair.liquidityToken.address);

              case 15:
                _context33.t2 = _context33.sent;
                totalSupply = new _context33.t0(_context33.t1, _context33.t2);
      ...
      function getDerivedBurnInfo(_x59, _x60, _x61, _x62) {
    ...
    value: function () {
      var _addUniswapLiquidity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee34(_ref10, _ref11, to) {
        var _amountsMin;
          ...
          while (1) {
            switch (_context34.prev = _context34.next) {
              case 0:
                ...
                slippage = _args34.length > 3 && _args34[3] !== undefined ? _args34[3] : 100;
                callback = _args34.length > 4 && _args34[4] !== undefined ? _args34[4] : {};
                _context34.next = 6;
              ...
              case 6:
                _yield$this$getDerive = _context34.sent;
      ...
      function addUniswapLiquidity(_x63, _x64, _x65) {
    ...
    value: function () {
      var _addUniswapETHLiquidity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee35(value, params) {
        var callback,
            _args35 = arguments;
        return regeneratorRuntime.wrap(function _callee35$(_context35) {
          while (1) {
            switch (_context35.prev = _context35.next) {
              case 0:
                callback = _args35.length > 2 && _args35[2] !== undefined ? _args35[2] : {};
      ...
      function addUniswapETHLiquidity(_x66, _x67) {
    ...
    value: function () {
      var _removeUniswapLiquidity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee36(tokenAType, tokenBType, liquidityValue, to) {
        var _amountsMin2;
        ...
        return regeneratorRuntime.wrap(function _callee36$(_context36) {
          while (1) {
            switch (_context36.prev = _context36.next) {
              case 0:
                slippage = _args36.length > 4 && _args36[4] !== undefined ? _args36[4] : 100;
                callback = _args36.length > 5 && _args36[5] !== undefined ? _args36[5] : {};
              ...
              case 8:
                _yield$this$getDerive2 = _context36.sent;
              ...
              case 13:
                ...
                return _context36.abrupt("return", this.triggerContract({
    ...
    value: function enchantFurnanceProps(formulaIndex, majorTokenId, minorTokenAddress) {
      ...
      return this.triggerContract({
        ...
        abiString: _abiFurnaceItemBase["default"],
    ...
    value: function () {
      var _equipLandResource = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee37(tokenId, resource, index, token, id) {
        var callback,
            resourceAddress,
            _args37 = arguments;
        return regeneratorRuntime.wrap(function _callee37$(_context37) {
          while (1) {
            switch (_context37.prev = _context37.next) {
              case 0:
                callback = _args37.length > 5 && _args37[5] !== undefined ? _args37[5] : {};
                _context37.next = 3;
                return this.getContractAddress(resource);

              case 3:
                resourceAddress = _context37.sent;
                return _context37.abrupt("return", this.triggerContract({
                  methodName: 'equip',
                  abiKey: 'apostleLandResource',
      ...
      function equipLandResource(_x72, _x73, _x74, _x75, _x76) {
        return _equipLandResource.apply(this, arguments);
      }

      return equipLandResource;
    }()
    /**
    ...
    key: "_sign",
    value: function () {
      var _sign2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee38(_ref12, from) {
        var data, name, signature;
        return regeneratorRuntime.wrap(function _callee38$(_context38) {
          while (1) {
            switch (_context38.prev = _context38.next) {
              case 0:
                data = _ref12.data, name = _ref12.name;
                _context38.prev = 1;
                _context38.next = 4;
    ...
    key: "login",
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee39(address) {
        var _this2 = this;
  ...
  return BscEvolutionLand;
}();

var _default = BscEvolutionLand;
