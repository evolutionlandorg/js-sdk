...
var FurnaceV1Api = {
  ...
  openFurnaceTreasure: function openFurnaceTreasure(_ref) {
    ...
    var silverBoxGasLimit = this.env.NETWORK === "1" ? new BigNumber(260000) : new BigNumber(350000);
    var goldBoxGasLimit = this.env.NETWORK === "1" ? new BigNumber(300000) : new BigNumber(400000);
    var gasLimit = new BigNumber(amounts[0]).lt("1000000000000000000000") ? silverBoxGasLimit : goldBoxGasLimit;
