...
var TronEvolutionLand = /*#__PURE__*/function () {
  ...
  _createClass(TronEvolutionLand, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _abi = this.ABIs[abiKey];
                _context.next = 7;
                return this._tronweb.contract().at(_abi.address);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                _context2.next = 14;
                return this._tronweb.contract(abiString, _abi.address);
              ...
              case 27:
                ...
                _extendPayload = _objectSpread(_objectSpread({}, payload), {}, {
                  _contractAddress: _abi2.address
                });
    ...
    value: function () {
      var _fetchByzantineSwapFee = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(value) {
        var callback,
            result,
            _args9 = arguments;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                ...
                return _context9.abrupt("return", result.toString());
      ...
      function fetchByzantineSwapFee(_x22) {
    ...
    value: function () {
      var _ByzantineSwapBridge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(value, targetAddress) {
        var symbol,
            callback,
            fee,
            extraData,
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                symbol = _args10.length > 2 && _args10[2] !== undefined ? _args10[2] : 'ring';
      ...
      function ByzantineSwapBridge(_x23, _x24) {
    ...
    key: "buyLuckyBox",
    value: function () {
      var _buyLuckyBox = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(buyer, goldBoxAmount, silverBoxAmount, callback) {
      ...
      function buyLuckyBox(_x25, _x26, _x27, _x28) {
    ...
    key: "getLuckyBoxInfo",
    value: function () {
      var _getLuckyBoxInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
    ...
    value: function () {
      var _getLuckyBoxSalesRecord = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(address) {
        var _contract, result;
      ...
      function getLuckyBoxSalesRecord(_x29) {
    ...
    */
    ...
    value: function () {
      var _approveRingToJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
        var callback,
            _args14 = arguments;
        return regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                callback = _args14.length > 0 && _args14[0] !== undefined ? _args14[0] : {};
    ...
    value: function () {
      var _checkJustswapAllowance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(amount) {
      ...
      function checkJustswapAllowance(_x30) {
    ...
    value: function () {
      var _getJustswapTrxBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
        var tradeobj;
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 2:
                tradeobj = _context16.sent;
                return _context16.abrupt("return", new _bignumber["default"](tradeobj.balance).toString(10));
    ...
    value: function () {
      var _getJustswapTokenBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
        var ring, balance;
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              ...
              case 2:
                ring = _context17.sent;
                _context17.next = 5;
                return ring.methods.balanceOf(this.ABIs['justswapExchange'].address).call();

              case 5:
                balance = _context17.sent;
                return _context17.abrupt("return", new _bignumber["default"](balance).toString(10));
    ...
    value: function () {
      var _getTrxToTokenOutputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
        var tokens_bought,
            amountInMax,
            _args18 = arguments;
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                tokens_bought = _args18.length > 0 && _args18[0] !== undefined ? _args18[0] : '1000000000000000000';
                _context18.t0 = this;
                _context18.t1 = tokens_bought;
                _context18.next = 5;
              ...
              case 8:
                ...
                amountInMax = _context18.t0.getOutputPrice.call(_context18.t0, _context18.t1, _context18.t2, _context18.t3);
                return _context18.abrupt("return", [new _bignumber["default"](amountInMax.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountInMax.toString(10)]);
    ...
    value: function () {
      var _getTokenToTrxInputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
        var tokens_bought,
            amountOutMin,
            _args19 = arguments;
          ...
          while (1) {
            switch (_context19.prev = _context19.next) {
              ...
              case 8:
                ...
                amountOutMin = _context19.t0.getInputPrice.call(_context19.t0, _context19.t1, _context19.t2, _context19.t3);
                return _context19.abrupt("return", [new _bignumber["default"](amountOutMin.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountOutMin.toString(10)]);
    ...
    key: "buyRingJustswap",
    value: function () {
      var _buyRingJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(value) {
        var callback,
            deadline,
        ...
        return regeneratorRuntime.wrap(function _callee20$(_context20) {
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                callback = _args20.length > 1 && _args20[1] !== undefined ? _args20[1] : {};
              ...
              case 4:
                _yield$this$getTrxToT = _context20.sent;
                ...
                return _context20.abrupt("return", this.triggerContract({
    ...
    value: function () {
      var _sellRingJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(value) {
        var callback,
            deadline,
        ...
        return regeneratorRuntime.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              case 0:
                callback = _args21.length > 1 && _args21[1] !== undefined ? _args21[1] : {};
                deadline = Math.floor(Date.now() / 1000) + 60 * 10; // 10 minutes from the current Unix time
              ...
              case 4:
                _yield$this$getTokenT = _context21.sent;
      ...
      function sellRingJustswap(_x32) {
