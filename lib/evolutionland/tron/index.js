          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this._tronweb.transactionBuilder.triggerSmartContract(_abi.address, functionSelector, this._tronweb.toSun(100), sendParams.callValue || 0, parameter, this.getCurrentAccount('hex')).then(function (_ref5) {
