...
var _indexV = _interopRequireDefault(require("../api/furnace/indexV1"));
...
var TronEvolutionLand = /*#__PURE__*/function () {
  function TronEvolutionLand(tronweb, network) {
    ...
    this.ERC20TRANSFERMETHOD = 'transferAndFallback'; // this.clientFetch = new ClientFetch({baseUrl: this.env.ABI_DOMAIN, chainId: 60})
  }
  /**
  ...
  _createClass(TronEvolutionLand, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return this._tronweb.contract().at(contractAddress);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                methodName = _ref3.methodName, abiKey = _ref3.abiKey, abiString = _ref3.abiString, _ref3$forceABI = _ref3.forceABI, forceABI = _ref3$forceABI === void 0 ? false : _ref3$forceABI, _ref3$contractParams = _ref3.contractParams, contractParams = _ref3$contractParams === void 0 ? [] : _ref3$contractParams, _ref3$sendParams = _ref3.sendParams, sendParams = _ref3$sendParams === void 0 ? {} : _ref3$sendParams, gasLimit = _ref3.gasLimit;
                ...
                this._tronweb.transactionBuilder.triggerSmartContract(_abi.address, functionSelector, gasLimit || this._tronweb.toSun(100), sendParams.value || 0, parameter, this.getCurrentAccount('hex')).then(function (_ref5) {
              ...
              case 11:
                ...
                _context2.next = 15;
                return this._tronweb.contract(abiString, contractAddress);
    ...
    value: function getContractAddress(tokenKey) {
      var token = this.ABIs[tokenKey] && this.ABIs[tokenKey].address || tokenKey;
      return token;
    }
    /**
    ...
    value: function () {
      var _erc721IsApprovedOrOwner = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(spender, contractAddress, tokenId) {
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 5:
                approvedAddress = _context9.sent;
                _context9.next = 8;
                return this.erc721IsApprovedForAll(owner, spender, contractAddress);

              case 8:
                isApprovedForAll = _context9.sent;
                return _context9.abrupt("return", owner.toLowerCase() === spender.toLowerCase() || approvedAddress.toLowerCase() === spender.toLowerCase() || isApprovedForAll);
      ...
      function erc721IsApprovedOrOwner(_x22, _x23, _x24) {
    ...
    key: "erc721Approve",
    value: function () {
      var _erc721Approve = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(to, tokenId, contractAddress) {
        var callback,
            _args10 = arguments;
      ...
      function erc721Approve(_x25, _x26, _x27) {
    ...
    value: function () {
      var _erc721SetApprovalForAll = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(to, approved, contractAddress) {
        var callback,
            _args11 = arguments;
      ...
      function erc721SetApprovalForAll(_x28, _x29, _x30) {
    ...
    value: function () {
      var _fetchByzantineSwapFee = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(value) {
        var callback,
            result,
            _args12 = arguments;
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                callback = _args12.length > 1 && _args12[1] !== undefined ? _args12[1] : {};
                _context12.next = 3;
                return this.callContract({
              ...
              case 3:
                ...
                return _context12.abrupt("return", result.toString());
      ...
      function fetchByzantineSwapFee(_x31) {
    ...
    value: function () {
      var _ByzantineSwapBridge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(value, targetAddress) {
        var symbol,
            callback,
            fee,
            extraData,
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                symbol = _args13.length > 2 && _args13[2] !== undefined ? _args13[2] : 'ring';
      ...
      function ByzantineSwapBridge(_x32, _x33) {
    ...
    key: "buyLuckyBox",
    value: function () {
      var _buyLuckyBox = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(buyer, goldBoxAmount, silverBoxAmount, callback) {
      ...
      function buyLuckyBox(_x34, _x35, _x36, _x37) {
    ...
    key: "getLuckyBoxInfo",
    value: function () {
      var _getLuckyBoxInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 5:
                ...
                return _context15.abrupt("return", result.map(function (item) {
    ...
    value: function () {
      var _getLuckyBoxSalesRecord = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(address) {
        var _contract, result;
      ...
      function getLuckyBoxSalesRecord(_x38) {
    ...
    */
    ...
    value: function () {
      var _approveRingToJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
        var callback,
            _args17 = arguments;
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                callback = _args17.length > 0 && _args17[0] !== undefined ? _args17[0] : {};
                return _context17.abrupt("return", this.triggerContract({
                  methodName: 'approve',
                  abiKey: 'ring',
    ...
    key: "approveToken",
    value: function () {
      var _approveToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(tokenContractOrType, spender) {
        var value,
            callback,
            _args18 = arguments;
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                value = _args18.length > 2 && _args18[2] !== undefined ? _args18[2] : "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff";
                callback = _args18.length > 3 && _args18[3] !== undefined ? _args18[3] : {};
      ...
      function approveToken(_x39, _x40) {
    ...
    value: function () {
      var _checkJustswapAllowance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(amount) {
        ...
        return regeneratorRuntime.wrap(function _callee19$(_context19) {
          while (1) {
            switch (_context19.prev = _context19.next) {
              ...
              case 5:
                ringContract = _context19.sent;
                _context19.next = 8;
                return ringContract.methods.allowance(from, this.ABIs['justswapExchange'].address).call();

              case 8:
                allowanceAmount = _context19.sent;
                return _context19.abrupt("return", !_index["default"].toBN(allowanceAmount).lt(_index["default"].toBN(amount || '1000000000000000000000000')));
      ...
      function checkJustswapAllowance(_x41) {
    ...
    value: function () {
      var _checkTokenAllowance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(amount, tokenAddressOrType, account, spender) {
      ...
      function checkTokenAllowance(_x42, _x43, _x44, _x45) {
    ...
    value: function () {
      var _getJustswapTrxBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21() {
        var tradeobj;
        return regeneratorRuntime.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 2:
                tradeobj = _context21.sent;
                return _context21.abrupt("return", new _bignumber["default"](tradeobj.balance).toString(10));
    ...
    value: function () {
      var _getJustswapTokenBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22() {
        var ring, balance;
        return regeneratorRuntime.wrap(function _callee22$(_context22) {
          while (1) {
            switch (_context22.prev = _context22.next) {
              ...
              case 2:
                ring = _context22.sent;
                _context22.next = 5;
                return ring.methods.balanceOf(this.ABIs['justswapExchange'].address).call();

              case 5:
                balance = _context22.sent;
                return _context22.abrupt("return", balance !== null && balance !== void 0 && balance._isBigNumber ? balance.toString() : new _bignumber["default"](balance).toString(10));
    ...
    value: function () {
      var _getTrxToTokenOutputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23() {
        var tokens_bought,
            amountInMax,
            _args23 = arguments;
        return regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
                tokens_bought = _args23.length > 0 && _args23[0] !== undefined ? _args23[0] : '1000000000000000000';
                _context23.t0 = this;
                _context23.t1 = tokens_bought;
                _context23.next = 5;
              ...
              case 8:
                ...
                amountInMax = _context23.t0.getOutputPrice.call(_context23.t0, _context23.t1, _context23.t2, _context23.t3);
                return _context23.abrupt("return", [new _bignumber["default"](amountInMax.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountInMax.toString(10)]);
    ...
    value: function () {
      var _getTokenToTrxInputPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24() {
        var tokens_bought,
            amountOutMin,
            _args24 = arguments;
          ...
          while (1) {
            switch (_context24.prev = _context24.next) {
              ...
              case 8:
                ...
                amountOutMin = _context24.t0.getInputPrice.call(_context24.t0, _context24.t1, _context24.t2, _context24.t3);
                return _context24.abrupt("return", [new _bignumber["default"](amountOutMin.toString(10)).times('1000000000000000000').div(tokens_bought).toFixed(0), amountOutMin.toString(10)]);
    ...
    key: "buyRingJustswap",
    value: function () {
      var _buyRingJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(value) {
        var callback,
            deadline,
        ...
        return regeneratorRuntime.wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              case 0:
                callback = _args25.length > 1 && _args25[1] !== undefined ? _args25[1] : {};
              ...
              case 4:
                _yield$this$getTrxToT = _context25.sent;
    ...
    value: function () {
      var _sellRingJustswap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(value) {
        var callback,
            deadline,
        ...
        return regeneratorRuntime.wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              ...
              case 4:
                _yield$this$getTokenT = _context26.sent;
      ...
      function sellRingJustswap(_x47) {
...
Object.assign(TronEvolutionLand.prototype, _indexV["default"]);
